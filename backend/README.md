...
Backend API for the Pretzel Shop e-commerce application built with Node.js, Express, PostgreSQL, and Redis. Traces, metrics, and profiles ship via OpenTelemetry and Pyroscope to the observability stack.
